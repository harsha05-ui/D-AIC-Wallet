...
import { Award, GraduationCap, ShieldCheck, ArrowRight, Wallet, Lock, Database, Globe, Layers, Cpu, Compass } from 'lucide-react';
import GlassCard from './ui/GlassCard';
import NeonButton from './ui/NeonButton';
import StatsCard from './ui/StatsCard';

export default function Home({ setTab, account, connectWallet }) {
  // Page entry stagger variants
    ...
    >
      ...
      <motion.div variants={itemVariants} className="relative text-center py-16 space-y-6 max-w-4xl mx-auto">
        ...
        <div className="pt-8 flex justify-center gap-4">
          {account ? (
            <div className="flex items-center gap-2.5 px-6 py-4 rounded-2xl bg-dark-900/60 border border-cyan-900/40 text-cyan-300 font-bold shadow-2xl backdrop-blur-md shadow-cyan-950/30">
              <Wallet className="w-5 h-5 text-cyan-400 animate-pulse-slow" />
      ...
      {/* Cybernetic Statistics Row utilizing StatsCard reusable components */}
      ...
      {/* Futuristic Workflow Interactive Roadmap */}
