...
export default function InstitutionDashboard({ account, provider, signer, connectWallet }) {
                        ...
                        <tbody className="divide-y divide-white/[0.02]">
                          {historyLogs.map((log) => (
                            <tr key={log.id} className="text-dark-200 hover:text-white transition-colors">
                              ...
                              <td className="py-3.5 pr-4 font-mono text-cyan-405 text-[10px]" title={log.cid}>
                ...
                {!account ? (
                          ...
                          {file ? (
                            <div className="space-y-3.5 relative z-10 animate-in fade-in duration-200">
                              ...
                              <div>
                                ...
                                <p className="text-[10px] font-bold text-cyan-405 mt-1 bg-cyan-950/60 px-2 py-0.5 rounded border border-cyan-900 inline-block uppercase">
                  ...
                  <GlassCard hover={false} className="p-12 rounded-[32px] border border-white/[0.04] text-center space-y-8 max-w-xl mx-auto relative overflow-hidden bg-dark-900/10">
                    ...
                    {status !== 'success' && status !== 'error' ? (
                      ...
                      <div className="space-y-8 py-6">
                        <div className="w-16 h-16 rounded-full bg-cyan-950/60 border border-cyan-500/40 flex items-center justify-center text-cyan-450 mx-auto shadow-2xl animate-bounce-slow">
                        ...
                        <div className="glass-card p-5 rounded-2xl text-left text-xs space-y-3.5 max-w-md mx-auto border border-white/[0.04] shadow-inner">
                          <div className="flex justify-between items-center">
                            <span className="text-dark-450 font-bold">IPFS CID:</span>
                            <a
                              href={useMock ? '#' : `https://gateway.pinata.cloud/ipfs/${ipfsHash}`}
                              target="_blank"
                              rel="noreferrer"
                              className="text-cyan-405 font-bold font-mono hover:underline truncate max-w-[200px]"
                            >
                              {ipfsHash}
                            </a>
                          </div>
                          {txHash && (
                            <div className="flex justify-between items-center">
                              <span className="text-dark-450 font-bold">Block Transaction:</span>
                              <span className="text-dark-200 font-mono select-all truncate max-w-[200px]">{txHash}</span>
                            </div>
                          )}
                          <div className="flex justify-between items-center">
                            <span className="text-dark-450 font-bold">Graduate Target:</span>
                      ...
                      <div className="flex items-center gap-3">
                        <label className="flex items-center gap-3 cursor-pointer text-xs font-semibold text-white select-none">
                          <input
                            ...
                            className="rounded text-brand-650 focus:ring-brand-500 bg-dark-900 border-white/[0.08] w-4.5 h-4.5 cursor-pointer"
                          />
