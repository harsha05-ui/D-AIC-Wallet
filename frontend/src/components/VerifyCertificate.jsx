...
export default function VerifyCertificate({ account, provider, signer }) {
        ...
        {loading ? (
          ...
          certs.length === 0 ? (
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-dark-400 max-w-md mx-auto leading-relaxed font-light">
                  ...
                  <code className="text-rose-405 font-mono text-[10px] block mt-2 bg-rose-950/40 p-1.5 rounded truncate">{searchAddress}</code>
                </p>
              </div>
            </motion.div>
          ) : (
            ...
            >
              ...
              <div className="hidden print:block border-b-2 border-brand-900 pb-4 mb-6">
